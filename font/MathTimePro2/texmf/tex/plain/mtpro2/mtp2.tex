% MTP2.TEX  VERSION 1.0 (January 25, 2006)
% COPYRIGHT (C) 1992, 1993, 2000, 2002, 2004-2006 BY PUBLISH OR PERISH, INC.
...
% The next two definitions are so that the \ifx\next clause in
% \specdelim@ won't be confused.
...
\def\ccases#1{\LEFTRIGHT\lcbrace.\,\vcenter{\normalbaselines\m@th
    \ialign{$##\hfil$&\quad##\hfil\crcr#1\crcr}}}
\ifx\amstexloaded@\relax
 \def\ccases#1\endccases{\bgroup\spreadmlines@\jot\LEFTRIGHT\lcbrace.{\matrix
...
\def\bm{\futurelet\next\bm@}%
\def\bm@{\ifx\next'\def\next@##1{\bprime@}\else
 \ifx\next\yen\def\next@\yen{\ifmmode\mathchar"0\mtbsya@@55\else\mathhexbox\mtbsy@@55\fi}\else
...
\def\hm{\futurelet\next\hm@}
\def\hm@{\ifx\next'\def\next@##1{\hprime@}\else
 \ifx\next\yen\def\next@\yen{\ifmmode\mathchar"0\mthsya@@55\else\mathhexbox\mthsy@@55\fi}\else
 \ifcat\noexpand\next0\def\next@{\hm@@}\else
...
\def\syadefs@{\def\ulcorner{\delimiter"4\mtsya@@70\mtsya@@70 }%
 ...
 \def\yen{\ifmmode\mathchar"\mtsya@@55\else\mathhexbox\mtsya@@55\fi}
...
\def\loadhrbdAt#1#2#3{%
 ...
 \else\def\next@####1{{\zstraight\fam\mthrbd@\relax\next}}\fi\fi
 \next@}
}
...
\def\loadbbAt#1#2#3{%
 ...
 \def\bb{\futurelet\next\bb@}%
 \def\bb@{\ifx\next\imath\def\next@####1{\mathchar"0\mtbb@@7B}%
 \else\ifx\next\jmath\def\next@####1{\mathchar"0\mtbb@@7C}%
 \else\def\next@####1{{\zstraight\fam\mtbb@\relax\next}}\fi\fi
 \next@}
}
...
\def\loadbbdAt#1#2#3{%
 ...
 \def\bbd{\futurelet\next\bbd@}%
 \def\bbd@{\ifx\next\imath\def\next@####1{\mathchar"0\mtbbd@@7B}%
 \else\ifx\next\jmath\def\next@####1{\mathchar"0\mtbbd@@7C}%
 \else\def\next@####1{\zstraight\fam\mtbbd@\relax\next}\fi\fi
 \next@}
}
...
\def\loadmscriptAt#1#2#3{%
 ...
 \else\ifx\next\altS\def\next@####1{\mathchar"0\mtmscript@@13}%
 \else\def\next@####1{{\zstraight\fam\mtmscript@\relax####1}}\fi\fi\fi\fi\fi\fi\fi\fi\fi\fi\fi
 \next@}
}
...
\def\loadbmscriptAt#1#2#3{%
 ...
 \else\ifx\next\altS\def\next@####1{\mathchar"0\mtbmscript@@13}%
 \else\def\next@####1{{\zstraight\fam\mtbmscript@\relax####1}}\fi\fi\fi\fi\fi\fi\fi\fi\fi\fi\fi
 \next@}
}
...
\def\loadmcurlyAt#1#2#3{%
 ...
 \def\mcurly@{\ifx\next\imath\def\next@####1{\mathchar"0\mtmcurly@@7B}%
 \else\ifx\next\jmath\def\next@####1{\mathchar"0\mtmcurly@@7C}%
 \else\ifx\next\altG\def\next@####1{\mathchar"0\mtmcurly@@07}%
 \else\ifx\next\altM\def\next@####1{\mathchar"0\mtmcurly@@0D}%
 \else\ifx\next\altN\def\next@####1{\mathchar"0\mtmcurly@@0E}%
 \else\ifx\next\altQ\def\next@####1{\mathchar"0\mtmcurly@@11}%
 \else\ifx\next\altY\def\next@####1{\mathchar"0\mtmcurly@@19}%
...
\def\loadmhbiAt#1#2#3{%
 ...
 \def\mhbi##1{\ifcat A##1{\fam\mtmhbi@\relax##1}%
  ...
  \else\mathchar"0\expandafter\mhbi@\meaning##1\mhbi@\fi\fi}%
...
\def\loadmbbiAt#1#2#3{%
 ...
 \def\mbbi##1{\ifcat A##1{\fam\mtmbbi@\relax##1}%
  ...
  \else\mathchar"0\expandafter\mbbi@\meaning##1\mbbi@\fi\fi}%
